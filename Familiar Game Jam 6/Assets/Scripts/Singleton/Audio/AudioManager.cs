...
public class AudioManager : Singleton<AudioManager>
{
    ...
    public float EffectSoundVolume
    {
        ...
        { 
            ...
            this.effectSoundAudioSource.volume = value.ClampToUnit();
        }
    }
    ...
    {
        if (!this.effectSoundMuted)
        {
            this.effectSoundAudioSource.clip = effectSoundClip;
            this.effectSoundAudioSource.Play();
        }
    }
    ...
    public void PlaySoundEffect(AudioClip soundEffectClip, Vector3 position)
    {
        if (!this.effectSoundMuted)
            AudioSource.PlayClipAtPoint(soundEffectClip, position, this.effectSoundVolume);
    }
    ...
    private void Awake()
    {
        ...
        this.effectSoundAudioSource = this.gameObject.AddComponent<AudioSource>();
        ...
        this.effectSoundAudioSource.loop = false;
        this.effectSoundAudioSource.mute = false;
        this.effectSoundAudioSource.priority = 16;
        this.effectSoundAudioSource.spatialBlend = 0.0f;
        this.effectSoundAudioSource.spatialize = false;
        
        // Asignar volumen
        this.musicAudioSource.volume = this.musicVolume;
        this.ambientSoundAudioSource.volume = this.ambientSoundVolume;
        this.effectSoundAudioSource.volume = this.effectSoundVolume;
    }
