...
public static class Localization
{
    ...
    // Métodos de gestión
    /// <summary>
    /// Carga los datos de localización del archivo de texto con nombre
    /// "Localization" ubicado en la carpeta de recursos.
    /// </summary>
    ...
    {
        // Interpretar texto como datos en formato CSV
        CsvSheet data = new CsvSheet(p);
